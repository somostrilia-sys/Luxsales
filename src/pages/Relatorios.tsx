...
import { relatorios, agentes } from "@/lib/mock-data";
...
export default function Relatorios() {
  ...
  const agentesUnicos = [...new Set(agentesEmpresa.map(a => a.nome))];

  const filtrados = relatoriosEmpresa.filter((r) => {
    ...
    <DashboardLayout>
      <div className="space-y-6">
        <div className="animate-fade-in">
          ...
          <p className="text-muted-foreground text-sm">Relatórios gerados — {empresa}</p>
        </div>
