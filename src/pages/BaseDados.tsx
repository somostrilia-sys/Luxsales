    ...
    <DashboardLayout>
      <div className="space-y-6">
        ...
        <div className="flex flex-wrap gap-3 items-end">
          <Input type="search" placeholder="Buscar nome/telefone..." value={search} onChange={e => { setSearch(e.target.value); setPage(0); }} className="w-64" autoComplete="new-password" name="leads-search" />
          <Input type="search" placeholder="Buscar cidade..." value={citySearch} onChange={e => { setCitySearch(e.target.value); setPage(0); }} className="w-44" autoComplete="new-password" name="leads-city" />
